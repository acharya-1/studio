    ...
    <header className={cn(
      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <Button asChild className="hidden sm:inline-flex transition-all duration-300 hover:scale-105 hover:shadow-lg bg-primary text-primary-foreground hover:bg-primary/90">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-80">
                <div className="p-4">
                  ...
                  <Button asChild className="w-full mt-8 bg-primary text-primary-foreground" onClick={() => setIsMobileMenuOpen(false)}>
                    <Link href="/quote">Request Staff</Link>
                  </Button>
                </div>
              </SheetContent>

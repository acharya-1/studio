...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <Card key={feature.title} className={`group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg stagger-animation opacity-0 bg-secondary/50 dark:bg-card`}>
      ...
      {/* About Section */}
      <section id="about" className="py-24 bg-secondary/30 dark:bg-card">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {featuredServices.map((service) => (
              <Card key={service.title} className="group flex flex-col text-center items-center transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 border-0 shadow-lg bg-card overflow-hidden relative">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <CardHeader>
                  <div className="mx-auto bg-secondary p-6 rounded-2xl group-hover:scale-110 transition-all duration-300 shadow-lg group-hover:shadow-xl">
                    <service.icon className="w-10 h-10 text-primary group-hover:text-purple-600 transition-colors duration-300" />
                  </div>
                  <CardTitle className="pt-6 font-headline text-lg group-hover:text-primary transition-colors duration-300">
                    {service.title}
                  </CardTitle>
                </CardHeader>
          ...
          <div className="text-center">
            <Button asChild size="lg" className="group bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 hover:scale-105 hover:shadow-xl px-8 py-4 text-lg">
              <Link href="/services">
      ...
      <section id="testimonials" className="py-24 bg-secondary/30 dark:bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4">
              ...
              {testimonials.map((testimonial, index) => {
                ...
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div className="p-1 h-full">
                    <Card className="group flex flex-col justify-between h-full p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border-0 shadow-lg bg-card">
